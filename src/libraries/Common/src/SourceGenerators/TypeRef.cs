...
namespace SourceGenerators
{
    ...
    public sealed class TypeRef : IEquatable<TypeRef>
    {
        ...
        /// <summary>
        /// Constructor for synthetic types that don't have an <see cref="ITypeSymbol"/>
        /// (e.g., the ambient <c>__JsonSerializableAmbientContext</c> generated by the source generator).
        /// </summary>
        internal TypeRef(string name, string fullyQualifiedName)
        {
            Name = name;
