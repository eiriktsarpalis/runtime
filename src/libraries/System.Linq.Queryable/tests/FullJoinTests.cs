...
namespace System.Linq.Tests
{
    public class FullJoinTests : EnumerableBasedTests
    {
        ...
        public void ResultSelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () => outer.AsQueryable().FullJoin(inner.AsQueryable(), e => e.name, e => e.name, (Expression<Func<CustomerRec, AnagramRec, JoinRec>>)null, new AnagramEqualityComparer()));
        }
        ...
        public void ResultSelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () => outer.AsQueryable().FullJoin(inner.AsQueryable(), e => e.name, e => e.name, (Expression<Func<CustomerRec, AnagramRec, JoinRec>>)null));
        }
