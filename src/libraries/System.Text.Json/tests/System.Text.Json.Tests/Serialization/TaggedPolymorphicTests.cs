...
{
    public class TaggedPolymorphicTests_Sync : TaggedPolymorphicTests
    {
    ...
    public class TaggedPolymorphicTests_Async : TaggedPolymorphicTests
    {
    ...
    public abstract class TaggedPolymorphicTests
    {
        ...
        {
            TaggedPolymorphicTypes =
            {
                new TaggedPolymorphicTypeConfiguration(typeof(HappyPath_BaseClass))
                {
                    KnownTypes =
                    {
                        [typeof(HappyPath_DerivedClass2)] = "derived_2",
                        [typeof(HappyPath_DerivedDerivedClass1)] = "derived_1",
                        [typeof(HappyPath_DerivedEnumerable)] = "enum",
                    }
                }
            }
        };
        ...
        private readonly static JsonSerializerOptions s_optionsWithCollectionKnownTypes = new JsonSerializerOptions
        {
            TaggedPolymorphicTypes =
                {
                    new TaggedPolymorphicTypeConfiguration(typeof(IEnumerable<int>))
                    {
                        KnownTypes =
                        {
                            [typeof(int[])] = "array",
                            [typeof(List<int>)] = "list",
                            [typeof(Queue<int>)] = "set"
                        }
                    },

                    new TaggedPolymorphicTypeConfiguration(typeof(IEnumerable<KeyValuePair<int, object>>))
                    {
                        KnownTypes =
                        {
                            [typeof(Dictionary<int, object>)] = "dictionary",
                            [typeof(ImmutableDictionary<int, object>)] = "immutableDictionary",
                            [typeof(IReadOnlyDictionary<int, object>)] = "readOnlyDictionary"
                        }
                    }
                }
        };
        ...
        [Fact]
        public void KnownTypeConfiguration_AddingKnownTypesAfterAssignmentToOptions_ShouldThrowInvalidOperationException()
        {
            var config = new TaggedPolymorphicTypeConfiguration(typeof(HappyPath_BaseClass));
            config.KnownTypes[typeof(HappyPath_DerivedClass1)] = "derived1";
            _ = new JsonSerializerOptions { TaggedPolymorphicTypes = { config } };
            Assert.Throws<InvalidOperationException>(() => config.KnownTypes[typeof(HappyPath_DerivedClass2)] = "derived2");
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new TaggedPolymorphicTypeConfiguration(baseType));
        }
        ...
        {
            var config = new TaggedPolymorphicTypeConfiguration(baseType);
            Assert.Throws<ArgumentException>(() => config.KnownTypes.Add(knownType, "knownTypeId"));
        }
        ...
        {
            var config = new TaggedPolymorphicTypeConfiguration(typeof(HappyPath_BaseClass));
            config.KnownTypes.Add(typeof(HappyPath_DerivedClass1), "id1");
            Assert.Throws<ArgumentException>(() => config.KnownTypes.Add(typeof(HappyPath_DerivedClass2), "id1"));
        }
            ...
            var options = new JsonSerializerOptions
            {
                TaggedPolymorphicTypes =
                {
                    new TaggedPolymorphicTypeConfiguration(typeof(IEnumerable<int>))
                    {
                        KnownTypes =
                        {
                            [typeof(ICollection<int>)] = "collection",
                            [typeof(IReadOnlyCollection<int>)] = "readonlycollection",
                        }
                    }
                }
            };
        ...
        public abstract record BinTree<T>
        {
            ...
            public static JsonSerializerOptions Options { get; } =
                new JsonSerializerOptions
                {
                    TaggedPolymorphicTypes =
                    {
                        new TaggedPolymorphicTypeConfiguration(typeof(BinTree<T>))
                        {
                            KnownTypes =
                            {
                                [typeof(Leaf)] = "leaf",
