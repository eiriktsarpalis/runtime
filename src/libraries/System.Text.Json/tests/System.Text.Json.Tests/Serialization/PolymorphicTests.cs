...
namespace System.Text.Json.Serialization.Tests
{
    ...
    public abstract class PolymorphicTests
    {
        ...
        {
            var options = new JsonSerializerOptions { PolymorphicSerializationResolver = new CustomPolymorphicTypeResolver(_ => false) };
        ...
        {
            var options = new JsonSerializerOptions { PolymorphicSerializationResolver = new CustomPolymorphicTypeResolver(type => type == typeof(ConcreteClass)) };
            ConcreteClass value = new DerivedClass { Boolean = true, Number = 42 };
        ...
        {
            var options = new JsonSerializerOptions { PolymorphicSerializationResolver = new CustomPolymorphicTypeResolver(type => type == typeof(AbstractClass)) };
            AbstractClass value = new ConcreteClass { Boolean = true };
            string expectedJson = @"{""Boolean"":true}";
        ...
        {
            var options = new JsonSerializerOptions { PolymorphicSerializationResolver = new CustomPolymorphicTypeResolver(type => type == typeof(IThing)) };
            IThing value = new MyOtherThing { Number = 42, OtherNumber = 24 };
        ...
        {
            var options = new JsonSerializerOptions { PolymorphicSerializationResolver = new CustomPolymorphicTypeResolver(_ => true) };
        ...
        class CustomPolymorphicTypeResolver : PolymorphicSerializationResolver
        {
            private readonly Func<Type, bool> _predicate;
            public CustomPolymorphicTypeResolver(Func<Type, bool> predicate) => _predicate = predicate;
            public override bool CanBePolymorphic(Type type) => _predicate(type);
        }
    }
}
