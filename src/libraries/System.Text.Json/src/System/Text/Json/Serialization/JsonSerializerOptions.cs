...
namespace System.Text.Json
{
    ...
    public sealed partial class JsonSerializerOptions
    {
        ...
        private ClassifierList? _classifiers;
        ...
        public JsonSerializerOptions(JsonSerializerOptions options)
        {
            ...
            _classifiers = options._classifiers is { } Classifiers ? new(this, Classifiers) : null;
        ...
        private sealed class ClassifierList : ConfigurationList<JsonTypeClassifierFactory>
        {
            private readonly JsonSerializerOptions _options;

            public ClassifierList(JsonSerializerOptions options, IList<JsonTypeClassifierFactory>? source = null)
                : base(source)
            {
                _options = options;
            }
