...
namespace System.Text.Json
{
    ...
    public sealed partial class JsonSerializerOptions
    {
        ...
        internal JsonSerializerContext? JsonSerializerContext
        {
            ...
            set
            {
                // To consider: strengthen check with VerifyMutable (likely a breaking change).
                ...
                // Setting a context alters JsonTypeInfo resolution logic,
                // even if options instance is already marked as immutable.
                // Need to invalidate any existing caching contexts.
                InvalidateCachingContext();
            }
        }
        ...
        internal void InitializeForReflectionSerializer()
        {
            ...
            // Enabling reflection alters JsonTypeInfo resolution logic,
            // even if options instance is already marked as immutable.
            // Need to invalidate any existing caching contexts.
            InvalidateCachingContext();
        }
