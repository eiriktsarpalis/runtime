...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        {
            Debug.Assert(referenceHandlingStrategy == ReferenceHandlingStrategy.Preserve || state.Current.TaggedPolymorphicTypeId is not null);
            ...
            if (referenceHandlingStrategy == ReferenceHandlingStrategy.Preserve)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (state.Current.TaggedPolymorphicTypeId is string typeId)
                        {
            ...
            {
                Debug.Assert(state.Current.TaggedPolymorphicTypeId is not null);
                writer.WriteString(s_TypeIdPropertyName, state.Current.TaggedPolymorphicTypeId);
                writtenMetadataName = MetadataPropertyName.Type;
            }
