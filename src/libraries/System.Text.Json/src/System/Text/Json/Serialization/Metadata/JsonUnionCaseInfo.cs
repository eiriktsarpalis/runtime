...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public sealed class JsonUnionCaseInfo
    {
        ...
        /// was declared as a nullable reference type (e.g. <c>Bird?</c>) or as
        /// <see cref="Nullable{T}"/>. When a JSON <see langword="null"/> is encountered during
        /// deserialization, the union case whose <see cref="IsNullable"/> is <see langword="true"/>
        /// is selected and its case constructor is invoked with <see langword="null"/>.
        /// At most one case per union may declare <see cref="IsNullable"/> when no custom
        /// <see cref="JsonTypeInfo.TypeClassifier"/> is configured.
        /// </remarks>
