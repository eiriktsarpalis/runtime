...
namespace System.Text.Json.Serialization.Converters
{
        ...
        where TAsyncEnumerable : IAsyncEnumerable<TElement>
    {
        ...
        {
            ThrowHelper.ThrowNotSupportedException_DeserializationNotSupported(typeToConvert);
            value = default;
            return false;
        }
        ...
        protected override void Add(in TElement value, ref ReadStack state) => throw new NotSupportedException();
        protected override void CreateCollection(ref Utf8JsonReader reader, ref ReadStack state, JsonSerializerOptions options) => throw new NotSupportedException();
    }
}
