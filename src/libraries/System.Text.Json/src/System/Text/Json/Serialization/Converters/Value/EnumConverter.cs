...
namespace System.Text.Json.Serialization.Converters
{
        ...
        where T : struct, Enum
    {
        ...
        internal override JsonTokenType[] GetSupportedJsonTokenTypes(JsonNumberHandling _)
        {
            EnumConverterOptions converterOptions = _converterOptions;
            ...
            {
                (true, true) => UnionTokenSets.StringOrNumber,
                (true, false) => UnionTokenSets.String,
                (false, true) => UnionTokenSets.Number,
                _ => UnionTokenSets.Number, // Defensive: at least one must be true; default to numeric.
            };
        }
