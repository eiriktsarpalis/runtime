...
namespace System.Formats.Cbor
{
    ...
    public partial class CborReader
    {
        ...
        /// <summary>Reads the next CBOR data item, returning a <see cref="System.ReadOnlyMemory`1" /> view of the encoded value. For indefinite length encodings this includes the break byte.</summary>
