...
namespace System.Formats.Cbor
{
    ...
    public partial class CborWriter
    {
        ...
        /// For instance, a map of size `1` containing a key of type int with a value of type string must be written by successive calls to <see cref="System.Formats.Cbor.CborWriter.WriteInt32(int)" /> and <xref:System.Formats.Cbor.CborWriter.WriteTextString(System.ReadOnlySpan{char})>.
