...
namespace System.Collections.Generic.Tests
{
    ...
    public class IListDefaultMethodTests
    {
        ...
        [Fact]
        public void Reverse_ReversesAllElements()
        {
            IList<int> list = new SimpleList<int>();
            foreach (int i in new[] { 1, 2, 3, 4, 5 }) list.Add(i);
        ...
        [Fact]
        public void Reverse_EmptyList_NoError()
        {
            IList<int> list = new SimpleList<int>();
            list.Reverse();
            Assert.Empty(list);
        ...
        [Fact]
        public void Reverse_TwoElements_Swaps()
        {
            IList<int> list = new SimpleList<int>();
            list.Add(1);
            list.Add(2);
        ...
        public void Reverse_Theory(int[] initial, int[] expected)
        {
            IList<int> list = new SimpleList<int>();
            foreach (int i in initial) list.Add(i);
        ...
        [Fact]
        public void Reverse_WorksWithList()
        {
            IList<int> list = new List<int> { 1, 2, 3, 4, 5 };
            list.Reverse();
